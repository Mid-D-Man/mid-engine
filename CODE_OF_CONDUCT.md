...
_This Code of Conduct is adapted from [Bevy](https://github.com/bevyengine/bevy)'s
Code of Conduct, which is itself based on the
...
characteristics, level of experience,
...
your fellow contributors comfortable. Everyone wants to get along and
...
- Private harassment is also unacceptable. No matter who you are, if
  ...
  by a community member, please contact the maintainer immediately.
  Whether you're a regular contributor or a newcomer, we care about
  making this community a safe place for you and we've got your back.
- Do not make casual mention of slavery or indentured servitude and/or
  false comparisons of one's occupation or situation to slavery.
  Please consider using or asking about alternate terminology when
  referring to such metaphors in technology.
- Likewise any spamming, trolling, flaming, baiting or other
  attention-stealing behavior is not welcome.

## Moderation

These are the policies for upholding
[our community's standards of conduct](#our-standards). If you feel
that a thread needs moderation, please contact the maintainer.

1. Remarks that violate the community standards of conduct, including
   hateful, hurtful, oppressive, or exclusionary remarks, are not
   allowed. (Cursing is allowed, but never targeting another
   contributor, and never in a hateful manner).
2. Remarks that the maintainer finds inappropriate, whether listed in
   the Code of Conduct or not, are also not allowed.
3. The maintainer will first respond to such remarks with a warning.
...
6. The maintainer may choose at their discretion to un-ban the user if
   it was a first offense and they offer the offended party a genuine
   apology.
7. If you believe a ban was unjustified, please take it up with the
   maintainer in private. Complaints about bans in-channel are not
   allowed.

The enforcement policies in this Code of Conduct apply to all official
venues, including this repository's Issues/PRs/Discussions and any
