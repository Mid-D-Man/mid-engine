...
// file live in docs/mid-math.md, section "wide/float/avx2/vec3x8.rs".
...
// `Vec3AxisSwizzle` can't be generated by `impl_vec3_axis_swizzle!` here the
// way it is for `Vec3x4` (see `swizzle/wide_float.rs`): that macro builds a
// struct literal assuming `x`/`y`/`z` fields directly, which only holds for
// `Vec3x4`'s true per-axis-register SoA layout. `Vec3x8` stores two `Vec3x4`
// halves instead (`lo`/`hi`, see this file's own header comment), so each
// permutation is expressed by swizzling both halves the same way and
// recombining — the same `Self::from_halves(self.lo.op(...), self.hi.op(...))`
// shape every other method on this type already uses.
impl Vec3AxisSwizzle for Vec3x8 {
    #[inline(always)]
    fn xxx(self) -> Self { Self::from_halves(self.lo.xxx(), self.hi.xxx()) }
    #[inline(always)]
    fn xxy(self) -> Self { Self::from_halves(self.lo.xxy(), self.hi.xxy()) }
    #[inline(always)]
    fn xxz(self) -> Self { Self::from_halves(self.lo.xxz(), self.hi.xxz()) }
    #[inline(always)]
    fn xyx(self) -> Self { Self::from_halves(self.lo.xyx(), self.hi.xyx()) }
    #[inline(always)]
    fn xyy(self) -> Self { Self::from_halves(self.lo.xyy(), self.hi.xyy()) }
    #[inline(always)]
    fn xyz(self) -> Self { Self::from_halves(self.lo.xyz(), self.hi.xyz()) }
    #[inline(always)]
    fn xzx(self) -> Self { Self::from_halves(self.lo.xzx(), self.hi.xzx()) }
    #[inline(always)]
    fn xzy(self) -> Self { Self::from_halves(self.lo.xzy(), self.hi.xzy()) }
    #[inline(always)]
    fn xzz(self) -> Self { Self::from_halves(self.lo.xzz(), self.hi.xzz()) }
    #[inline(always)]
    fn yxx(self) -> Self { Self::from_halves(self.lo.yxx(), self.hi.yxx()) }
    #[inline(always)]
    fn yxy(self) -> Self { Self::from_halves(self.lo.yxy(), self.hi.yxy()) }
    #[inline(always)]
    fn yxz(self) -> Self { Self::from_halves(self.lo.yxz(), self.hi.yxz()) }
    #[inline(always)]
    fn yyx(self) -> Self { Self::from_halves(self.lo.yyx(), self.hi.yyx()) }
    #[inline(always)]
    fn yyy(self) -> Self { Self::from_halves(self.lo.yyy(), self.hi.yyy()) }
    #[inline(always)]
    fn yyz(self) -> Self { Self::from_halves(self.lo.yyz(), self.hi.yyz()) }
    #[inline(always)]
    fn yzx(self) -> Self { Self::from_halves(self.lo.yzx(), self.hi.yzx()) }
    #[inline(always)]
    fn yzy(self) -> Self { Self::from_halves(self.lo.yzy(), self.hi.yzy()) }
    #[inline(always)]
    fn yzz(self) -> Self { Self::from_halves(self.lo.yzz(), self.hi.yzz()) }
    #[inline(always)]
    fn zxx(self) -> Self { Self::from_halves(self.lo.zxx(), self.hi.zxx()) }
    #[inline(always)]
    fn zxy(self) -> Self { Self::from_halves(self.lo.zxy(), self.hi.zxy()) }
    #[inline(always)]
    fn zxz(self) -> Self { Self::from_halves(self.lo.zxz(), self.hi.zxz()) }
    #[inline(always)]
    fn zyx(self) -> Self { Self::from_halves(self.lo.zyx(), self.hi.zyx()) }
    #[inline(always)]
    fn zyy(self) -> Self { Self::from_halves(self.lo.zyy(), self.hi.zyy()) }
    #[inline(always)]
    fn zyz(self) -> Self { Self::from_halves(self.lo.zyz(), self.hi.zyz()) }
    #[inline(always)]
    fn zzx(self) -> Self { Self::from_halves(self.lo.zzx(), self.hi.zzx()) }
    #[inline(always)]
    fn zzy(self) -> Self { Self::from_halves(self.lo.zzy(), self.hi.zzy()) }
    #[inline(always)]
    fn zzz(self) -> Self { Self::from_halves(self.lo.zzz(), self.hi.zzz()) }
}
